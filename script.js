...
// Данные для рекомендаций
        const plantData = {
            lettuce: {
                name: 'Салат и зелень',
                system: 'Система глубоководных культур (DWC), система питательного слоя (NFT)',
                difficulty: 'Низкая',
            ...
            herbs: {
                name: 'Пряные травы',
                system: 'система капельного полива, система питательного слоя (NFT)',
                difficulty: 'Средняя',
            ...
            strawberry: {
                ...
                system: 'Система капельного полива, система питательного слоя (NFT)',
                difficulty: 'Сложная',
                harvest: 'C момента цветения от 10 до 14 недель',
                tips: 'Любит прохладу. Нужно опыление (можно вручную кисточкой).'
            },
             strawberries: {
                name: 'Земляника',
                system: 'Система питательного слоя (NFT), система периодического затопления (Ebb & Flow)',
                difficulty: 'Средняя',
                harvest: 'C момента цветения от 8 до 12 недель',
                tips: 'Любит прохладу. Нужно опыление (можно вручную кисточкой).'
            }
        ...
        materials.push('Субстрат (кокосовое волокно, кубики root riot, торфяные таблетки, минераловые пробки, керамзит)');
        materials.push('Двухкомпонентные удобрения для гидропоники (двухкомпонентное Plagron Hydro А+В, однокомпонентное био-минеральное удобрение Bio Nova Aqua, Terraflex, Universor, сбалансированный минеральный комплекс Flora gro)');
        ...
        if (this.userSelections.budget === 'minimal') {
            materials.push('Пластиковые горшки с отверстиями, стеклянные горшки');
            materials.push('Ёмкости для проращивания семян (кокосовые диски, кассеты, минераловатные пробки)');
            materials.push('Воздушный компрессор для аквариума (для DWC)');
        } else if (this.userSelections.budget === 'medium') {
            materials.push('Горшки для гидропоники (сетчатые, горшки вкладыши из кокосового волокна - применяется как вкладыш для сетчатых горшков)');
            materials.push('Гроубэг - изготавливают из геотекстиля и наполняют минватой, пеностеклом или серамисом, удачно сочетается с капельной системой полива');
            materials.push('Дополнительный поддон для стекания излишков воды');
            materials.push('Насос и таймер (для периодического затопления)');
            materials.push('Фитолампа (если мало естественного света)');
        } else if (this.userSelections.budget === 'unlimited') {
            materials.push('Готовый набор для гидропоники - "Умные горшки" - они создают оптимальные условия (влажность и воздухообмен. Горшок с автополивом - состоит из емкости с двойным дном. в вверхней части располагается гидропонный субстрат, в нижний наливают гидропонный раствор)');
