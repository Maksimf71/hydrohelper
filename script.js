...
const HydroHelper = {
    ...
    generateRecommendation: function() {
        ...
        const plantData = {
            ...
            herbs: {
                name: 'Пряные травы',
                system: 'Капиллярная система (фитильная)',
    ...
    addPhotoToPlant: function(plantId) {
        ...
        // Для демо-версии просто добавляем дату
    ...
    setupCalculator: function() {
        ...
        calculateBtn.addEventListener('click', () => {
            ...
            const recipes = {
                ...
                strawberry: { A: 12, B: 12, pHDown: 1.5, description: 'Клубника любит среднюю концентрацию' }
            };
